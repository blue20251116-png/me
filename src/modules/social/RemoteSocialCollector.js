...
import { DirectInstagramCollector } from './DirectInstagramCollector.js';
...
export function collectorFor(platform){
  ...
  // Instagram is intentionally direct-first and does not require Apify.
  if(p==='INSTAGRAM')return new DirectInstagramCollector();
