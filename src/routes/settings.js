...
settingsRouter.put('/keys',(req,res)=>{
  try{
    ...
    for(const name of ['OPENAI_API_KEY','PEXELS_API_KEY','YOUTUBE_API_KEY','SERPAPI_API_KEY','COUPANG_ACCESS_KEY','COUPANG_SECRET_KEY']) if(Object.prototype.hasOwnProperty.call(keys,name)) setSecret(name,String(keys[name]||'').trim());
